...
public class BlockHSVConfiguration
{
	...
	private String blockNamePrefixOverride;
	...
	public void overrideBlockNamePrefix(final String prefix) {
		this.blockNamePrefixOverride = prefix;
	}

	public String getBlockName(
			final int varientNum )
	{
		final String base = blockNamePrefixOverride != null ? blockNamePrefixOverride : type.blockName;
		if ( type == EnumFlatBlockType.NORMAL && blockNamePrefixOverride == null )
		{
			return base;
		}
		...
		return base + "_" + shadeConvertVariant[varientNum];
	}
